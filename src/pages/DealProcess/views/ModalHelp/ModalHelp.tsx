...
const HelpModal: React.FC<IHelpModal> = props => {
        ...
        <div className="modal-help__content">
          <div className="modal-help__item">
            ...
            <p className="modal-help__text">
              ...
              ligula elementum. Etiam arcu erat, fermentum sit amet imperdiet sit amet, placerat vel arcu. Phasellus eu eros ac orci
              tincidunt luctus ut in leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Duis
              quis ornare quam, a blandit lacus. Aenean faucibus facilisis dapibus.
            </p>
            <p className="modal-help__text">
